...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2026 at 06:46 PM
...
('ODR_1', 'bu-0', '68 ', 4, 260.00, 'aa a', '+8801870500658', 'sd sdf sds s', 'bkash', 'Rejected', '2026-01-14 13:11:50', NULL, ''),
('ODR_1', 'bu-0', '69 ', 4, 2200.00, 'aa a', '+8801870500658', 'sd sdf sds s', 'bkash', 'Rejected', '2026-01-14 13:11:50', NULL, ''),
('ODR_10', 'bu-0', '100', 4, 600.00, 'abdullah al mubin', '+8801870500653', 'kuril, kaji bari mosjid', 'bkash', 'Pending', '2026-01-14 23:42:22', 100, 'Dhaka'),
...
('ODR_6', 'bu-0', '68 ', 2, 130.00, 'aa a', '+8801870500658', 'sd sdf sds s', 'bkash', 'Pending', '2026-01-14 23:23:03', 100, ''),
...
(68, 'Fresh Milk', 'Pure cow milk from local dairy farm.', 65, 140, 'https://images.unsplash.com/photo-1550583724-b2692b85b150?w=400', 'se-1', NULL, 'Liter', 'Dairy', '2026-01-14 11:25:25'),
(69, 'Beef', 'Fresh beef from farm cattle.', 550, 92, 'https://images.unsplash.com/photo-1588347818036-c6298ed47881?w=400', 'se-1', NULL, 'Kg', 'Meat', '2026-01-14 11:25:25'),
(70, 'Coriander Leaves', 'Fresh coriander for garnishing.', 20, 79, 'https://images.unsplash.com/photo-1614343621865-e9c6fc544694?w=400', 'se-1', NULL, 'Bundle', 'Other', '2026-01-14 11:25:25'),
...
(72, 'Fresh Tomatoes', 'Ripe red tomatoes, perfect for salads and cooking.', 45, 393, 'https://images.unsplash.com/photo-1546470427-e26264be0d3b?w=400', 'se-1', NULL, 'Kg', 'Vegetable', '2026-01-14 11:38:01'),
(73, 'Green Chili', 'Hot green chilies, freshly harvested.', 60, 150, 'https://images.unsplash.com/photo-1583663824728-c5e0d899ed2b?w=400', 'se-1', NULL, 'Kg', 'Vegetable', '2026-01-14 11:38:01'),
...
(75, 'Carrots', 'Sweet orange carrots, rich in vitamin A.', 50, 350, 'https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?w=400', 'se-1', NULL, 'Kg', 'Vegetable', '2026-01-14 11:38:01'),
(76, 'Brinjal', 'Fresh purple brinjal/eggplant.', 35, 180, 'https://images.unsplash.com/photo-1659261200833-ec8761558af7?w=400', 'se-1', NULL, 'Kg', 'Vegetable', '2026-01-14 11:38:01'),
(77, 'Cabbage', 'Green fresh cabbage, great for salads.', 30, 250, 'https://images.unsplash.com/photo-1594282486552-05b4d80fbb9f?w=400', 'se-1', NULL, 'Kg', 'Vegetable', '2026-01-14 11:38:01'),
...
(80, 'Pumpkin', 'Large sweet pumpkin from farm.', 38, 280, 'https://images.unsplash.com/photo-1570586437263-ab629fccc818?w=400', 'se-1', NULL, 'Kg', 'Vegetable', '2026-01-14 11:38:01'),
...
(100, 'Haribhanga mango', 'The Haribhanga mango is a famous, sweet, fiberless mango variety from Rangpur, Bangladesh, known for its rich aroma, juicy flesh, and distinctive taste', 150, 117, '../../assets/files/product_img/PROD_Haribhanga mango1768412431.jpg', 'se-1', NULL, 'Kg', 'Fruit', '2026-01-14 23:40:31');
...
--
ALTER TABLE `basket`
  MODIFY `basket_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
